...
class Valor{
    constructor(id,opcion,casa,descripcion){
        this.id = id,
        this.opcion = opcion,
        this.casa = casa,
...
const valores2 = new Valor (2, "Justicia y lealtad", "Hufflepuff", "Los hufflepuff son buenas personas y suelen caer bien a todo el mundo. Son pacientes, tolerantes y siempre harán todo de forma honrada, sin hacer trampas y respetando las reglas.")
const valores3 = new Valor (3, "Sabiduria y voluntad", "Ravenclaw", "Los miembros de esta casa se caracterizan por su ingenio, aprendizaje, sabiduríay voluntad. El símbolo animal emblemático es el águila, y el azul y el bronce son sus colores.")
